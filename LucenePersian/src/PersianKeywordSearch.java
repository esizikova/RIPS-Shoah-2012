...
public class PersianKeywordSearch {//changed to Persian
	...
	public static File file2 = new File("Persian.csv");  // file in which results of the code will be saved; changed to Persian
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in Persian.csv");//changed to Persian
        searcher.close();
    }
