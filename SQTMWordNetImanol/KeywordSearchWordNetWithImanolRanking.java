...
public class KeywordSearchWordNetWithImanolRanking {
	...
	public static File file2 = new File("Spanish_WPDI.csv");//output file
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        for (int k = 0; k < 2357; k++){
        	...
        	wordNetStuff(findMe);
        	int max = 0;
        	List<IndexItem> result1 = new ArrayList<IndexItem>();
