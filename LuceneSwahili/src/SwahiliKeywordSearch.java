...
public class SwahiliKeywordSearch { //changed to swahili
	...
	public static File file2 = new File("Swahili.csv");  // file in which results of the code will be saved; changed to Swahili
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in Swahili.csv");
        searcher.close();
    }
