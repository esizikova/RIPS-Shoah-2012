...
public class GermanKeywordSearch {//changed to German
	...
	public static File file2 = new File("German.csv");  // file in which results of the code will be saved; changed to German
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in German.csv");//changed to German
        searcher.close();
    }
