...
import org.apache.lucene.analysis.de.GermanAnalyzer;//changed to German
...
class Indexer{
	...
	public Indexer(String indexDir) throws IOException {
		//create the index
		if (indexWriter == null) {
			indexWriter = new IndexWriter(FSDirectory.open(new File("keywordList")), new IndexWriterConfig(Version.LUCENE_36, new GermanAnalyzer(Version.LUCENE_36)));//changed to German
