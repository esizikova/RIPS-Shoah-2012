...
public class ArabicKeywordSearch {//changed name to Arabic
	...
	public static File file2 = new File("Arabic.csv");  // file in which results of the code will be saved; changed to Arabic
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in Arabic.csv");//changed to Arabic
        searcher.close();
    }
