...
import org.apache.lucene.analysis.ru.RussianAnalyzer;//changed to Russian
...
class Indexer{
	...
	public Indexer(String indexDir) throws IOException {
		//create the index
		if (indexWriter == null) {
			indexWriter = new IndexWriter(FSDirectory.open(new File("keywordList")), new IndexWriterConfig(Version.LUCENE_36, new RussianAnalyzer(Version.LUCENE_36)));
