...
public class RussianKeywordSearch {//changed to Russian
	...
	public static File file2 = new File("Russian.csv");  // file in which results of the code will be saved; changed to Russian
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in Russian.csv");//changed to Russian
        searcher.close();
    }
