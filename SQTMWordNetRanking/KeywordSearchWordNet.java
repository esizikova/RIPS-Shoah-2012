...
public class KeywordSearchWordNet {
	...
	public static File file2 = new File("Spanish_IMDb_WPDFR.csv");//output file
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        for (int k = 0; k < 2357; k++){
        	...
        	findMe = parts1[1];
        	wordNetStuff(findMe);
        	List<String> newList = FilterWithRanking.filterWithRanking(synonyms, filterWords, stopWords);
