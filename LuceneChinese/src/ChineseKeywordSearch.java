...
public class ChineseKeywordSearch { //changed to Chinese
	...
	public static File file2 = new File("Chinese.csv");  // file in which results of the code will be saved; changed to Chinese
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        output.flush();
        output.close();
        System.out.println("Your file has been saved. Search results are recorded in Chinese.csv");//changed to Chinese
        searcher.close();
    }
