...
public class KeywordSearchWordNet {
	...
	public static File file2 = new File("Russian_IMDb_WordNet_Pivot_Direct_Filter.csv");//output file
	public static List<String> synonyms = new ArrayList<String>();
	public static File file3 = new File("synonyms.csv");
	public static File file4 = new File("filter_words2.txt");
	public static String word2;
	public static File file5 = new File("WordsFilteredOut.txt");
	public static File file6 = new File("stop_words1.txt");
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        //import filter file
        Scanner scan2 = new Scanner(file4, "UTF-8");
        String[][] filterWords = new String [486327][2];
        for (int t = 0; t < 486327; t++){
        	String line = scan2.nextLine();
        	String [] parts = line.split("\\t");
        	filterWords[t][0] = parts[0];
        	filterWords[t][1] = parts[1];
        }
        Scanner scan4 = new Scanner(file6, "UTF-8");
        String [] stopWords = new String[357];
        for(int w = 0; w < 357; w++){
        	stopWords[w] = scan4.nextLine();
        }

        //import queries file
        File file1 = new File("ru2en_IMDB_pivotplusdirect1.txt");
        Scanner scan3 = new Scanner(file1, "UTF-8");
        String [] query = new String [2389];
        ...
        for (int k = 0; k < 2389; k++){
        	...
        	for (int n = 0; n < synonyms.size(); n++){
        		...
        		String word3 = Filter.filter(synonyms.get(n), filterWords, stopWords);
        		//System.out.println("Word 3 = " + word3);
	        	List<IndexItem> result = searcher.findBySearchLabel(word3, DEFAULT_RESULT_SIZE);
