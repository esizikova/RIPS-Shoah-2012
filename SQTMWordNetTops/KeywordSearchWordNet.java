...
public class KeywordSearchWordNet {
	...
	public static File file2 = new File("presentation_test.csv");//output file
    ...
    public static void main(String[] args) throws IOException, ParseException {
        ...
        //import queries file
        File file1 = new File("presentation_query.txt");
        ...
        for (int k = 0; k < 3; k++){
        	...
        	findMe = parts1[1];
        	wordNetStuff(findMe);
        	List<String> newList = FilterWithTops.filterWithTops(synonyms, filterWords, stopWords);
        	for (int n = 0; n < newList.size(); n++){
	        	List<IndexItem> result = searcher.findBySearchLabel(newList.get(n), DEFAULT_RESULT_SIZE);
